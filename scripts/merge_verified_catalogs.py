...
CATALOGS = [
    ...
    ROOT / 'assets' / 'milkalliance_yagotynske_verified_part5.json',
    ROOT / 'assets' / 'milkalliance_yagotynske_verified_part6.json',
    ROOT / 'assets' / 'milkalliance_pyriatyn_verified.json',
    ROOT / 'assets' / 'milkalliance_pyriatyn_verified_part2.json',
    ROOT / 'assets' / 'milkalliance_slavia_verified.json',
    ROOT / 'assets' / 'milkalliance_slavia_verified_part2.json',
    ROOT / 'assets' / 'milkalliance_yagotynske_children_verified.json',
    ROOT / 'assets' / 'milkalliance_yagotynske_children_verified_part2.json',
    ROOT / 'assets' / 'milkalliance_yagotynske_children_verified_part3.json',
    ROOT / 'assets' / 'galychyna_verified_part1.json',
    ROOT / 'assets' / 'galychyna_verified_part2.json',
    ROOT / 'assets' / 'galychyna_verified_part3.json',
