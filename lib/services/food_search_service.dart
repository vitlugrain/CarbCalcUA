...
class FoodSearchService {
  ...
  static String stem(String token) {
    ...
    const aliases=<String,String>{
      ...
      'воді':'вод','водою':'вод','водний':'вод','рису':'рис','рисом':'рис','картопля':'картопл','картоплі':'картопл','картоплю':'картопл','картоплею':'картопл',
      'морква':'моркв','моркви':'моркв','моркву':'моркв','цибуля':'цибул','капуста':'капуст','баклажан':'баклажан','огірок':'огірок','помідор':'помідор','буряк':'буряк','кабачок':'кабачок','гарбуз':'гарбуз','банана':'банан','банану':'банан','яблука':'яблук','яблуко':'яблук','яблуці':'яблук',
  ...
  static List<FoodSearchResult> search(String query,List<Product> products,{int limit=30}){
    ...
    for(final p in candidates){
      ...
      final brandLikeLatin=RegExp(r'^[a-z0-9 ]+$').hasMatch(q) && q.length>=4;
